         ...
         (forall ((Itl19 Nat))
            (=>
               ...
               (and
                  ...
                  ;Update array variable a at location l22
                  (and
                     (= (a (l23 Itl19) (i (l19 Itl19))) (+ (a (l22 Itl19) (i (l19 Itl19))) 1))
                     (forall ((pos Int))
                        (=>
                           (not
                              (= pos (i (l19 Itl19)))
                           )
                           (= (a (l23 Itl19) pos) (a (l22 Itl19) pos))
                        )
                     )
                  )
                  ...
                  (forall ((pos Int))
                     (= (a (l19 (s Itl19)) pos) (a (l23 Itl19) pos))
                  )
               )
            )
         )
