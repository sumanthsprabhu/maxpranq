...
(rule (=> (and (inv i N a b c) (< i N) (= (store c i 1) c1) (= (store b i (select b i)) b1) (= (store a i (select a i)) a1) (= i1 (+ i 1))) (inv i1 N a1 b1 c1)))

(rule (=> (and (inv i N a b c) (>= i N) (<= 0 i1) (< i1 N) (not (or (> (select a i1) (select b i1)) (> (select a i1) (select c i1))))) fail))
