...
(rule (=> (and (inv1 i N a b c) (< i N) (= (store a i (+ 1 (select c i))) a1) (= (store c i (select c i)) c1) (= (store b i (select b i)) b1) (= i1 (+ i 1))) (inv1 i1 N a1 b1 c1)))
...
(rule (=> (and (inv0 i N a b c) (< i N) (= (store b i (select c i)) b1) (= (store c i (select c i)) c1) (= (store a i (select a i)) a1) (= i1 (+ i 1))) (inv0 i1 N a1 b1 c1)))
...
(rule (=> (and (inv i N a b c) (< i N) (= (store a i (+ 1 (select a i))) a1) (= (store b i (select b i)) b1) (= (store c i (select c i)) c1)(= i1 (+ i 1))) (inv i1 N a1 b1 c1)))

(rule (=> (and (inv i N a b c) (< i N) (= (store a i (+ 2 (select b i))) a1) (= (store b i (select b i)) b1) (= (store c i (select c i)) c1) (= i1 (+ i 1))) (inv i1 N a1 b1 c1)))

(rule (=> (and (inv i N a b c) (>= i N) (<= 0 i1) (< i1 N) (not (= (select a i1) 42))) fail))
