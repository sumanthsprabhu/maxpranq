...
(rule (=> (and (inv2 a b i N) (< i N) (= (store a i (+ (select a i) 1)) a1) (= (store b i (select b i)) b1) (= i1 (+ i 1))) (inv2 a1 b1 i1 N)))
(rule (=> (and (inv2 a b i N) (< i N) (= (store b i (+ (select b i) 1)) b1) (= (store a i (select a i)) a1) (= i1 (+ i 1))) (inv2 a1 b1 i1 N)))
