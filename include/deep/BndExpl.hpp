...
//          outs () << "\b\b]\n";
  ...
  inline void execChc(string chcfile, ufo::ZSolver<ufo::EZ3> & m_smt_solver, map<Expr, vector<vector<int> > > & models,int bnd = 10)
  {
    ExprFactory m_efac;
    EZ3 z3(m_efac);
    CHCs ruleManager(m_efac, z3);
    ...
    BndExpl ds(ruleManager);
    unrollAndExecuteMultiple(m_smt_solver, models, bnd);
  }
